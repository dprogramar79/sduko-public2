...
const PopupWrapper = () => {
  ...
  <div className="popup-content">
    ...
    {/* <div className="popup-footer">
      <a href="http://localhost:3000" className="popup-btn" onClick={handleDisagree} >Decline</a>
      <button id="adultCookie" type="button" className="popup-btn popup-btn-primary" onClick={handleAgree}>Accept</button>

      <button className="popup-btn popup-btn-primary" onClick={handleAgree}>Agree</button>
      <button className="popup-btn" onClick={handleDisagree}>Disagree</button>
    ...
    <div className="popup-footer">
      <Link href="/" className="popup-btn">Decline</Link>
      <button
        id="adultCookie"
        type="button"
